...
class TestIsTemplatedPluginFile:
    @pytest.mark.parametrize(
        ...
        [
            (
                "templated/templateddetector/plugins/cve/2025/Bar_CVE_2025_0001.textproto",
                True,
            ),
            (
                "templated/templateddetector/plugins/exposedui/Foo_ExposedUi.textproto",
                True,
            ),
            ...
            (
                "google/detectors/credentials/x/src/main/resources/data/service_default_credentials.textproto",
                False,
            ),
            ...
            (
                "templated/templateddetector/plugins/cve/2025/Bar_CVE_2025_0001.java",
                False,
            ),
        ],
    )
...
class TestDiscoverPlugins:
    def _make_repo(self, tmp_path):
        ...
        (jdir / "FooDetector.java").write_text(
            '.setPublisher("CVE").setValue("CVE-2020-1111")'
        )
        ...
        (odir / "service_default_credentials.textproto").write_text(
